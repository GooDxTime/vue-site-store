            ...
            <ul class="colors">
              <li class="colors__item" v-for="categoryColor in categoriesColor" :key="categoryColor.id">
                <label class="colors__label">
                  <input class="colors__radio sr-only" type="radio" name="color" :value="categoryColor.id" v-model.number="categoryColor.color" checked=""> 
                  <span class="colors__value" :style="setColor(categoryColor.color)">
                  </span>
                </label>
              </li>
            </ul>
            ...
            <ul class="check-list">
              <li class="check-list__item">
                <label class="check-list__label">
                  <input class="check-list__check sr-only" type="checkbox" name="volume" value="8" @click="changeColor">
 ...
 export default {
   ...
   methods:{
     ...
     changeColor(value){
      return this.$emit('change', this.currentCategoryColor)
     }
   }
 }
 </script>
