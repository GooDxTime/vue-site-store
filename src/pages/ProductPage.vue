          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row">
              <div class="form__counter">
                <button type="button" aria-label="Убрать один товар" @click.prevent="decCount">
                ...
                <button type="button" aria-label="Добавить один товар">
                  <svg width="12" height="12" fill="currentColor" @click.prevent="incCount">
...
export default {
    ...
    methods:{
      ...
      addToCart(){
        this.$store.commit(
          'addProductToCart',
          {productId: this.product.id, amout: this.productAmount}
        );
      },
      decCount(){
